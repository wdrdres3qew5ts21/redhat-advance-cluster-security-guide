...
![redhat-advance-cluster-security](images/cover.png)

Medium Blog: https://wdrdres3qew5ts21.medium.com/%E0%B8%95%E0%B8%A3%E0%B8%A7%E0%B8%88%E0%B8%88%E0%B8%B1%E0%B8%9A%E0%B8%8A%E0%B9%88%E0%B8%AD%E0%B8%87%E0%B9%82%E0%B8%AB%E0%B8%A7%E0%B9%88-log4shell-%E0%B8%82%E0%B8%AD%E0%B8%87-container-application-%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%A7%E0%B8%B4%E0%B8%98%E0%B8%B5%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B9%83%E0%B8%8A%E0%B9%89-red-hat-advanced-cluster-security-f34272fda98c
...
#### หัวข้อ
0. การติดตั้ง Advanced Cluster Security ผ่าน Operator
1. การสร้าง Network Policy Kubernetes จาก Topology Visualization
2. การสร้างทำ Benchmark Compliance Cluster ตาม CIS Benchmarks, NIST, PCI และ HIPAA
3. การสร้าง Custom Policy ตรวจจับช่องโหว่ Log4Shell
4. การสร้าง Custom Policy ตรวจจับช่อง Container Image ที่มีช่องโหว่ตามเงื่อนไข
5. การสร้าง Custom Policy ป้องกันพฤติกรรมผู้ใช้ Excute เข้าไปใน Pod
6. ตรวจสอบ Container Image ที่ถูกแสกน

ซึ่งวันนี้เองเราจะลองมาทดลองใช้ Product  Red Hat Advance Cluster Security โดยแต่เดิมนั้นก็คือ StackRox ซึ่งเป็น Platform Security Container ที่ Red Hat ได้ซื้อมาและเป็นส่วนหนึ่ง Project Opensource ชื่อว่า Open Cluster Management ซึ่งตอนนี้กำลังเป็น Sandbox Project ของ Cloud Native Computing Foundation https://open-cluster-management.io 
...
ซึ่งสรุป Network Topology จะช่วยแสดงภาพ Traffic และ NetworkPolicy ที่เราใช้งานอยู่เพื่อให้เราที่เป็นคน Config สามารถเห็นภาพเข้าใจได้ง่ายขึ้นนั่นเองซึ่งในส่วนต่อไปคือเรื่องของการตั้ง Policy แล้วเพื่อตรวจจับ Application ที่มีช่องโหว่ แต่ถ้าเรายังคุ้นๆอยู่ เราจะนึกกฏที่ถูกละเมิดใน Tabs Violations จะมี column enforced นั้นถูกต้องค่าไว้เป็น no อยู่ซึ่งทำให้การบังคับไม่เกิดขึ้นนั่นเองเพียงแต่มีการ Logs เก็บข้อมูลเอาไว้ดังนั้นแล้วสำหรับหัวข้อต่อไปที่เกือบจะใกล้ถึงการตรวจจับ Log4Shell ของเราก็ใกล้มาถึงแล้วจริงๆนะ (น้ำตาจะไหล 5555) แต่ตอนนี้เพื่อนๆน่าจะเห็นว่าด้วยเทคนิคของ eBPF ทำให้การตรวจจับ Traffic ระดับ Low Level นั้นเกิดขึ้นได้จริงในสภาพแวดล้อมของ Linux ปัจจุบันนั่นเอง
