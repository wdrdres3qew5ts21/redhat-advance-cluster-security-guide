...
![support-matrix](images/intro/admission.png)
...
![support-matrix](images/ebpf/timeline.png)

![support-matrix](images/ebpf/arch.png)
...
![support-matrix](images/ebpf/flow.png)
...
![support-matrix](images/net/trace.png)
...
![support-matrix](images/net/window.png)


### Architecture

หลังจากที่เราได้เห็นภาพรวมของจักรวาล eBPF ที่ผมเองก็รู้สึกอึ้งเหมือนกันไปแล้ว 55555 (รู้สึกตัวเองอยู่บนผิวยอดเขา Everest ข้างล่างมีทะเลลึกมากซ่อนอยู่ข้างใต้ TwT) เรากลับมาดูสิ่งที่เกี่ยวข้องกับการลงกันครั้งนี้คือ Spec ที่ใช้งานจะเป็น
